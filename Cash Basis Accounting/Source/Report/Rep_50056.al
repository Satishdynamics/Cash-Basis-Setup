report 50056 "SLGI Cash Trial Bal GlobDim"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Trial Balance, per Global Dim..rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Cash Basis Trial Balance, per Global Dimension';
            ...
            area(Content)
            {
                group(Options)
                {
                    ...
                    group("Select Report Columns")
                    {
                        ...
                        field(VarianceInBalances; ColumnFlags[11])
                        {
                            ApplicationArea = Suite;
                        ...
                        field(PCTVarianInBalances; ColumnFlags[12])
                        {
                            ApplicationArea = Suite;
                            Caption = '% Variance in Balances';
                            ToolTip = 'Specifies that a column is inserted that shows the percentage of variance in balances. The variance is calculated by dividing the variance by the actual amounts.';
    ...
    var
        ...
        Text014: Label 'Cash Trial Balance';
