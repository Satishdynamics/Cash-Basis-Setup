report 50055 "SLGI Cash TrialBal Spread GDim"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Trial Balance, Spread G. Dim..rdl';
    Caption = 'Cash Basis Trial Balance, Spread Global Dimension';
    ...
    var
        ...
        Text011: Label 'Cash Trial Balance';
