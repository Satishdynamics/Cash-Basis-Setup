report 50053 "SLGI Cash Trial Balance"
{
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                then begin
                    ...
                    CalcFields("SLGI CSH Net Change Cash", "SLGI CSH Balance at Date Cash");
                    WorkAmount[1] := "SLGI CSH Net Change Cash";
                    WorkAmount[7] := "SLGI CSH Balance at Date Cash";
                    if Show = Show::Budget then begin
                        ...
                        CalcFields("SLGI CSH Net Change Cash", "SLGI CSH Balance at Date Cash");
                        WorkAmount[3] := "SLGI CSH Net Change Cash";
                        WorkAmount[9] := "SLGI CSH Balance at Date Cash";
                    end;
    ...
    var
        ...
        Text101: Label 'Data';
        Text102: Label 'Cash Basis Trial Balance';
        ...
        PageGroupNo: Integer;
        TrialBalanceCaptionLbl: Label 'Cash Basis Trial Balance';
    ...
    begin
        ExcelBuf.CreateNewBook('Cash Basis Trial Balance');
        ExcelBuf.WriteSheet('Cash Basis Trial', CompanyName(), UserId());
        ExcelBuf.CloseBook();
        ExcelBuf.OpenExcel();
    end;
